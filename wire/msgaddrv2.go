...
// MsgAddrV2 v2版本，unknown command
type MsgAddrV2 struct {
	AddrList []*NetAddress
}

// AddAddress adds a known active peer to the message.
func (msg *MsgAddrV2) AddAddress(na *NetAddress) error {
...
func (msg *MsgAddrV2) AddAddresses(netAddrs ...*NetAddress) error {
...
// NewMsgAddrV2 returns a new bitcoin addr message that conforms to the
